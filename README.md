...
2. **Välkomst Meddelande**: Användaren får en ASCII art Logo och sedan en meny för att logga in eller avsluta programmet
3. **Inloggning**
- Anvädaren anger Användar namn och lösenord
...
- Om en amdin loggar in hamnar de i en alternativ meny för enbart Admins, där kan kunder bli skapade och valutas värde bli updatering
5.**Utloggning**: När Användaren väljer loggout så kommer deras user bli satt till null och dem kommer tas til Inloggning

<h2 align="center"><u>Object och Klasser</u></h2>
1.**Program.cs**: Skapar Bank objectet för att Köra Programet
...
-**Client**: En vanlig bankkund. Ärver fårn user så att användare får ett bankkonto
